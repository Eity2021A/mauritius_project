...
export const eventsInfo = {
  en: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Saturday, 4 April 2026",
        description: "A retro-inspired Easter Saturday party at N' JOY with a Y2K theme - expect bold visuals, a stacked DJ and live lineup, and an electric crowd. Exclusive event; tickets via Otayo.",
  ...
  fr: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Samedi 4 avril 2026",
        description: "Une soirée de Pâques au style rétro chez N' JOY, avec un thème Y2K, des visuels forts, une programmation DJ et live bien remplie, et une ambiance électrique. Événement exclusif ; billets via Otayo.",
        holdersNote: "Réservé aux détenteurs de billets Otayo",
        admissionNote: "La direction se réserve le droit d'admission.",
      },
    },
  ...
  de: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Samstag, 4. April 2026",
        description: "Eine retro-inspirierte Easter-Saturday-Party im N' JOY mit Y2K-Thema: starke Visuals, ein dichtes DJ- und Live-Line-up und eine energiegeladene Crowd. Exklusives Event; Tickets über Otayo.",
        holdersNote: "Nur für Inhaber von Otayo-Tickets",
        admissionNote: "Das Management behält sich das Recht auf Einlass vor.",
      },
    },
  ...
  it: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Sabato 4 aprile 2026",
        description: "Una festa del sabato di Pasqua dal gusto retro al N' JOY, con tema Y2K: visual decisi, un ricco DJ e live line-up e un pubblico carico di energia. Evento esclusivo; biglietti tramite Otayo.",
        holdersNote: "Solo per possessori di biglietto Otayo",
        admissionNote: "La direzione si riserva il diritto di ammissione.",
      },
    },
  ...
  es: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Sábado, 4 de abril de 2026",
        description: "Una fiesta de Sábado de Pascua con estilo retro en N' JOY y tema Y2K: visuales potentes, un cartel completo de DJ y actuaciones en vivo, y un ambiente eléctrico. Evento exclusivo; entradas por Otayo.",
        holdersNote: "Solo para titulares de entradas de Otayo",
        admissionNote: "La dirección se reserva el derecho de admisión.",
      },
    },
  ...
  ru: {
    ...
    eventDetails: {
      "easter-saturday-y2k-2026": {
        title: "Easter Saturday Y2K",
        displayDate: "Суббота, 4 апреля 2026",
        description: "Ретро-вечеринка Easter Saturday в N' JOY в стиле Y2K: яркие визуальные эффекты, насыщенная DJ- и live-программа и заряженная атмосфера. Эксклюзивное событие; билеты через Otayo.",
        holdersNote: "Только для владельцев билетов Otayo",
        admissionNote: "Администрация оставляет за собой право отказать во входе.",
      },
    },
