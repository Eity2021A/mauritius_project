...
export const topActivities: AcrossItem[] = [
...
export const topBeaches: AcrossItem[] = [
...
export const topPlaces: AcrossItem[] = [
...
export const hiddenGems: AcrossItem[] = [
...
export interface AcrossSectionConfig {
  title: string;
  dotColor: string;
  items: AcrossItem[];
  hrefPrefix: string;
...
export const acrossSections: AcrossSectionConfig[] = [
  {
    title: "Activities",
