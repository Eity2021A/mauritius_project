...
const featuredTitleFallbacks = {
  ...
  "south-mauritius-road-trip-guide": {
    en: "South Mauritius Road Trip Guide",
    fr: "Road trip dans le sud de Maurice",
    de: "Roadtrip-Guide für Süd-Mauritius",
    it: "Guida road trip del sud di Mauritius",
    es: "Guía de road trip por el sur de Mauricio",
    ru: "Маршрут по югу Маврикия на машине",
  },
  "best-restaurants-in-south-mauritius-2026-guide": {
    en: "Best Restaurants in South Mauritius 2026",
    fr: "Meilleurs restaurants du sud de Maurice 2026",
    de: "Beste Restaurants im Süden von Mauritius 2026",
    it: "I migliori ristoranti nel sud di Mauritius 2026",
    es: "Mejores restaurantes del sur de Mauricio 2026",
    ru: "Лучшие рестораны юга Маврикия 2026",
  },
  "exploring-mahebourg-mauritius": {
    en: "Exploring the Village of Mahébourg and the South-East",
    fr: "Explorer Mahébourg et le sud-est",
    de: "Mahébourg und den Südosten entdecken",
    it: "Esplorare Mahébourg e il sud-est",
    es: "Explorando Mahébourg y el sureste",
    ru: "Исследуем Маэбур и юго-восток",
  },
  "best-places-to-see-monkeys-in-mauritius": {
    en: "Best Places to See Monkeys in Mauritius",
    fr: "Où voir des singes à Maurice",
    de: "Die besten Orte, um Affen auf Mauritius zu sehen",
    it: "I posti migliori per vedere le scimmie a Mauritius",
    es: "Mejores lugares para ver monos en Mauricio",
    ru: "Лучшие места, где увидеть обезьян на Маврикии",
  },
  "east-mauritius-travel-guide": {
    en: "East Mauritius Travel Guide",
    fr: "Guide de l'est de Maurice",
    de: "Reiseführer Ost-Mauritius",
    it: "Guida dell'est di Mauritius",
    es: "Guía del este de Mauricio",
    ru: "Путеводитель по востоку Маврикия",
  },
  "best-restaurants-in-east-mauritius-2026-guide": {
    en: "Best Restaurants in East Mauritius 2026",
    fr: "Meilleurs restaurants de l'est de Maurice 2026",
    de: "Beste Restaurants im Osten von Mauritius 2026",
    it: "I migliori ristoranti nell'est di Mauritius 2026",
    es: "Mejores restaurantes del este de Mauricio 2026",
    ru: "Лучшие рестораны востока Маврикия 2026",
  },
  "10-beaches-to-visit-in-mauritius": {
    en: "10 Beaches to Visit in Mauritius",
    fr: "10 plages à visiter à Maurice",
    de: "10 Strände, die man auf Mauritius besuchen sollte",
    it: "10 spiagge da visitare a Mauritius",
    es: "10 playas para visitar en Mauricio",
    ru: "10 пляжей, которые стоит посетить на Маврикии",
  },
  "west-mauritius-travel-guide": {
    en: "West Mauritius Travel Guide",
    fr: "Guide de l'ouest de Maurice",
    de: "Reiseführer West-Mauritius",
    it: "Guida dell'ovest di Mauritius",
    es: "Guía del oeste de Mauricio",
    ru: "Путеводитель по западу Маврикия",
  },
  "best-restaurants-in-west-mauritius-2026-guide": {
    en: "Best Restaurants in West Mauritius 2026",
    fr: "Meilleurs restaurants de l'ouest de Maurice 2026",
    de: "Beste Restaurants im Westen von Mauritius 2026",
    it: "I migliori ristoranti nell'ovest di Mauritius 2026",
    es: "Mejores restaurantes del oeste de Mauricio 2026",
    ru: "Лучшие рестораны запада Маврикия 2026",
  },
  "exploring-chamarel-mauritius": {
    en: "Exploring Chamarel: A Local Guide",
    fr: "Explorer Chamarel : guide local",
    de: "Chamarel entdecken: ein lokaler Guide",
    it: "Esplorare Chamarel: guida locale",
    es: "Explorar Chamarel: guía local",
    ru: "Исследуем Шамарель: местный гид",
  },
  "hiking-seven-waterfalls-mauritius": {
    en: "Hiking the Seven Waterfalls in Mauritius",
    fr: "Randonnée aux Sept Cascades à Maurice",
    de: "Wandern zu den Sieben Wasserfällen auf Mauritius",
    it: "Trekking alle Sette Cascate a Mauritius",
    es: "Senderismo por las Siete Cascadas en Mauricio",
    ru: "Поход к Семи водопадам на Маврикии",
  },
  "mauritius-local-food-guide": {
    en: "Mauritius Local Food Guide",
    fr: "Guide de la cuisine locale à Maurice",
    de: "Guide zur lokalen Küche auf Mauritius",
    it: "Guida al cibo locale di Mauritius",
    es: "Guía de comida local de Mauricio",
    ru: "Гид по местной еде Маврикия",
  },
  "nature-reserves-and-parks-mauritius": {
    en: "Nature Reserves and Parks in Mauritius",
    fr: "Réserves naturelles et parcs à Maurice",
    de: "Naturreservate und Parks auf Mauritius",
    it: "Riserve naturali e parchi a Mauritius",
    es: "Reservas naturales y parques en Mauricio",
    ru: "Природные заповедники и парки Маврикия",
  },
} as const;
