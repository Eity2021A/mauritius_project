...
const MARKETS_COPY: Record<Locale, MarketsPageCopy> = {
  ...
  fr: {
    metadata: {
      ...
      description:
        "Les meilleurs marchés de Maurice - street food, épices, artisanat et textiles à Port-Louis, Flacq, Quatre Bornes et Grand Baie, avec conseils pour marchander.",
      alternates: { canonical: "/best-markets-of-mauritius" },
    },
    ...
    markets: makeMarkets([
      {
        ...
        location: "Port-Louis",
        buy: "Street food, produits frais, épices, fruits tropicaux et souvenirs - goûtez le dholl puri, le gâteau piment et l'alouda.",
      ...
      },
      {
        ...
        buy: "L'un des plus grands marchés de l'île - fruits, légumes, vêtements, textiles, snacks et épices.",
      ...
      },
      {
        ...
        buy: "Tenues de plage, sacs, chapeaux, robes, bijoux et artisanat, pratique près des resorts.",
    ...
    markets: makeMarkets([
      {
        ...
        location: "Port Louis",
        buy: "Streetfood, Gemüse, Gewürze, tropische Früchte und Souvenirs - probiere Dholl Puri, Gateau Piment und Alouda.",
    ...
    markets: makeMarkets([
      {
        ...
        location: "Port Louis",
        buy: "Street food, prodotti freschi, spezie, frutta tropicale e souvenir - prova dholl puri, gateau piment e alouda.",
      ...
      },
      {
        ...
        type: "Mercato tradizionale",
        location: "Central Flacq - Est",
        buy: "Uno dei mercati più grandi dell'isola - frutta, verdura, vestiti, tessuti, snack e spezie.",
  ...
  es: {
    ...
    markets: makeMarkets([
      ...
      },
      {
        ...
        type: "Mercado tradicional",
        location: "Central Flacq - Este",
        buy: "Uno de los más grandes de la isla - fruta, verdura, ropa, textiles, snacks y especias.",
      ...
      },
      {
        ...
        buy: "Ropa de playa, bolsos, sombreros, vestidos, joyas y artesanía, cómodo para los resorts.",
  ...
  ru: {
    ...
    markets: makeMarkets([
      {
        ...
        location: "Порт-Луи",
        buy: "Уличная еда, свежие продукты, специи, тропические фрукты и сувениры - попробуйте dholl puri, gateau piment и alouda.",
      ...
      },
      {
        ...
        tip: "Совместите с набережной, музеем и Blue Bay.",
      },
      {
        name: "Базар Гранд-Бэ",
    ...
    localTips: [
      ...
      [
        "Ешьте там, где людно",
        "Выбирайте оживленные точки; уточняйте остроту - dholl puri, самосы и бирьяни.",
      ],
    ],
