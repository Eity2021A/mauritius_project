...
import { getContactInfo } from "@/data/main-info-translations";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const t = getContactInfo(locale);
  return { title: t.metadata.title, description: t.metadata.description, alternates: { canonical: "/contact" } };
}
