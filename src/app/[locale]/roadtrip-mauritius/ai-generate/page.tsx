...
/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Tag definitions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
const TAGS: TagDef[] = [
  ...
  { id: "sea", label: "Sea", icon: "ðŸŒŠ" },
  { id: "waterfall", label: "Waterfalls", icon: "ðŸ’§" },
  { id: "hiking", label: "Hiking", icon: "ðŸ¥¾" },
  { id: "air", label: "Air", icon: "ðŸš" },
  { id: "photography", label: "Photography", icon: "ðŸ“¸" },
  { id: "swim", label: "Swim Spots", icon: "ðŸŠ" },
  { id: "nature", label: "Nature", icon: "ðŸŒ¿" },
  { id: "culture", label: "Culture", icon: "ðŸ›ï¸" },
  { id: "islands", label: "Islands", icon: "ðŸï¸" },
];

/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Pool entry (place or activity â†’ stop) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
function entriesToItinerary(
  ...
  return {
    id: "ai-generated",
    slug: "ai-generate",
    title: translate("Your Custom Itinerary"),
    subtitle: localizedTagLabels.join(" · "),
    image: entries[0]?.image,
    stops,
    info: [
      translate("Generated based on your interests: {tags}.").replace("{tags}", localizedTagLabels.join(", ")),
      translate("Stops are ordered geographically to minimise driving."),
      translate("Tap 'View stop details' for more info on each stop."),
      translate("Hit 'Start Over' at the top to try different interests."),
    ],
  };
}

/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Page component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */

export default function AiGeneratePage() {
  const params = useParams<{ locale?: string }>();
  const locale = params.locale ?? "en";
  const t = useCallback((text: string) => staticPageText(locale, text), [locale]);
    ...
    setTimeout(() => {
      ...
      const timer = setInterval(() => {
        ...
        if (elapsed >= totalMs) {
          ...
          const it = entriesToItinerary(picked, selectedTags, t);
          setItinerary(it);
          setProgress(100);
  ...
  /* â”€â”€â”€ Result phase: reuse the itinerary detail view â”€â”€â”€ */
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
          <div className="w-full max-w-md space-y-6 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900">
              {t("Preparing your itinerary...")}
            </h2>
            <p className="text-gray-500 text-sm">
              {t("Finding the best stops based on your interests")}
            </p>
      ...
      <div className="max-w-2xl mx-auto px-4 pt-28 pb-16">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            {t("Let AI Create Your Itinerary")}
          </h1>
          <p className="text-gray-500 max-w-md mx-auto">
            {t("Select your interests below and we'll build a personalised itinerary across Mauritius.")}
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          {selectedTags.length === 0 && (
            <p className="text-xs text-gray-400 mt-3">
              {t("Select at least one interest to get started")}
            </p>
          )}
        </div>
      </div>
