...
const sectionLinks = [
  [
    "/beaches-in-mauritius/grand-baie",
    "/beaches-in-mauritius/la-cuvette",
    undefined,
    "/blog/best-restaurants-in-north-mauritius-2026-guide",
    "/mauritius-activities",
  ],
  [
    "/beaches-in-mauritius/pereybere-beach",
    "/beaches-in-mauritius/cap-malheureux",
    "/top-activities-mauritius/ilot-gabriel",
    "/beaches-in-mauritius/mont-choisy",
...
export async function generateMetadata({
  ...
  const t = getExploringGuide(activeLocale, "grandbaie");
  return {
...
export default async function ExploringGrandbaiePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <main id="main-content" className="min-h-screen bg-white text-[#1c2a2e]">
      ...
      <article className="mx-auto w-full max-w-6xl px-4 pt-24 pb-10 sm:px-6 lg:pt-28 xl:px-0">
        ...
        <section className="mt-20">
          <Image
            src="/images/quick-trips/exploring-grandbaie.png"
            alt={`${t.title} ${t.titleEmphasis}`}
            width={1200}
            height={600}
