        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center px-4 max-w-4xl mx-auto translate-y-[2rem]">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              Mauritius Island: Your Complete Travel Guide
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 text-justify">
              ...
              <p className="text-lg leading-relaxed">
                <span className="font-semibold text-orange-500">Bonzour, and welcome to Mauritius.</span> Mauritius, also called Ile Maurice in French, is the island of the dodo and one of the Indian Ocean&apos;s brightest travel destinations. It combines beach holidays, city experiences, mountain scenery, culture, food and outdoor activities in one compact island. Mauritius is a multicultural country shaped by African, Indian, European and Chinese influences. The island sits in the Indian Ocean, south of the Equator and east of Madagascar, between longitudes 57°16&apos; and 57°49&apos; east, and latitudes 19°58&apos; and 20°34&apos; south.
              </p>
              <h3 className="text-xl font-bold text-gray-900 mt-6">
                Getting there
              </h3>
              <p className="text-lg leading-relaxed mt-4">
                Whether you arrive with{" "}
                ...
                or connect through{" "}
                <a href="https://www.emirates.com/" target="_blank" rel="noopener noreferrer" className="font-semibold text-orange-500 hover:text-orange-600 underline">Emirates</a>, the first view of sapphire water, white sand{" "}
                <Link href="/beaches-in-mauritius" className="font-semibold text-orange-500 hover:text-orange-600 underline">beaches</Link>,{" "}
                and green mountains sets the tone for the trip. Port Louis, the capital, adds markets, history, shopping and waterfront dining to the beach experience. Mauritius is also a favourite for honeymooners and families, with everything from luxury resorts to simpler guesthouses. If you&apos;re into photography or just an Instagram fan, we listed{" "}
              ...
              <p className="text-lg leading-relaxed mt-4">
                Mauritius has much more to offer than a simple beach break. There are many{" "}
                <Link href="/mauritius-activities" className="font-semibold text-orange-500 hover:text-orange-600 underline">activities</Link>{" "}
                to enjoy, including hiking, ziplining, snorkelling, mountain viewpoints and boat trips. Le Morne Brabant is one of the island&apos;s most famous outdoor landmarks. Check our{" "}
                ...
                guide, rent a car or book a taxi, and explore the island without missing the key stops. Start with the{" "}
                ...
                and use our blog guides for practical planning details.
              </p>
              <p className="text-lg leading-relaxed mt-4">
                Regularly ranked among the world&apos;s favourite island destinations, Mauritius is a place where you can watch sunrise, sunset and mountain views in the same trip. Direct and connecting flights from Europe, Africa, Asia and Australia make it easy to combine a beach holiday with culture, nature and road-trip days.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 text-justify mb-10">
              ...
              <p className="text-lg leading-relaxed mt-4">
                ...
                <Link href="/roadtrip-mauritius" className="font-semibold text-orange-500 hover:text-orange-600 underline">itinerary explore trip here</Link>.
              </p>
            </div>
