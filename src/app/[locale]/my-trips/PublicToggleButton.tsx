          ...
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
            {isPublic ? (
              <path
                ...
                d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-3 0h15a2.25 2.25 0 012.25 2.25v5.25A2.25 2.25 0 0119.5 20.25h-15A2.25 2.25 0 012.25 18V12.75A2.25 2.25 0 014.5 10.5z"
              />
            ) : (
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M18.75 8.25h-13.5a2.25 2.25 0 00-2.25 2.25v7.5a2.25 2.25 0 002.25 2.25h13.5a2.25 2.25 0 002.25-2.25v-7.5a2.25 2.25 0 00-2.25-2.25zM7.5 8.25V6.75a4.5 4.5 0 019 0"
              />
            )}
          </svg>
        )}
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">{t("shareWithCommunity")}</h3>
                <p className="text-sm text-gray-500">{t("shareVisibleHint")}</p>
              </div>
            </div>
            ...
            <div className="mb-5">
              ...
              >
                ...
                />
                <div>
                  <span className="text-sm font-medium text-gray-900">{t("hideMyName")}</span>
                  <p className="text-xs text-gray-500 mt-0.5">{t("hideMyNameHint")}</p>
                </div>
              </label>
            </div>
