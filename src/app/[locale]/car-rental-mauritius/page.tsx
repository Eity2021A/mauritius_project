...
export const legacyCarRentalMetadata: Metadata = {
  ...
  alternates: { canonical: "/car-rental-mauritius" },
};
...
export default async function CarRentalPage({
  ...
  return (
    <main id="main-content" className="min-h-screen bg-white">
      ...
      />
      <ItemListJsonLd
        name={car.itemListName}
        description={car.itemListDescription}
        itemType="Service"
      ...
      <section className="bg-[#fff] py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto ">
                ...
                {vehicleCategories.map((category, index) => (
                  ...
                  >
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <a
                        href="https://www.hertz.mu/"
                        target="_blank"
                        rel="sponsored noopener noreferrer"
                        className="self-start sm:self-center"
                      >
                        <button className="inline-flex items-center justify-center rounded-lg bg-orange-500 px-6 py-2 text-xs font-bold uppercase text-white">
                          {car.searchCar}
                        </button>
                      </a>
                    </div>
                ...
                <div className="grid gap-5 md:grid-cols-3 md:gap-0">
                  {travelAddOns.map((item, index) => (
                    ...
                    >
                      ...
                      <div>
                        <h3 className="lg:text-2xl text-[1.25rem] font-bold leading-tight text-gray-900">
                          {car.addOns[index] ?? item.name}
                        </h3>
                        <p className="mt-2 flex items-end gap-2 leading-none">
                          <span className="lg:text-2xl text-[1.25rem] font-bold text-orange-500">
                            {item.price}
                          </span>
            ...
            <div className="mt-16 mx-auto max-w-6xl rounded-2xl border border-orange-100 bg-orange-50/40 p-6 sm:p-8">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-orange-500">
                {car.drivingTitle}
              </p>
            ...
            <div className="mt-16 mx-auto max-w-6xl">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                {carRentalFaqs.map((item) => (
                  <article key={item.question} className="rounded-2xl border border-orange-100 bg-white p-5 shadow-sm">
