...
import { FAQJsonLd, ItemListJsonLd } from "@/components/seo/JsonLd";
...
export const legacyItineraryMetadata: Metadata = {
  title: "Mauritius Itinerary: 3, 5, 7 & 10 Day Travel Plans (2026 Guide)",
  description: LEGACY_PAGE_DESCRIPTION,
  alternates: {
...
export default async function MauritiusItineraryPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const topPlaces = TOP_PLACES.map((place, index) => ({
    ...place,
    ...t.topPlaces[index],
  }));
  const stayRegions = STAY_REGIONS.map((region, index) => ({
    ...region,
    ...t.stayRegions[index],
  }));
  const articleJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: t.schema.breadcrumbItineraries,
        item: `${SITE_URL}/roadtrip-mauritius`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: t.schema.breadcrumbCurrent,
  ...
  return (
    <main id="main-content" className="min-h-screen bg-white">
      ...
      <ItemListJsonLd
        ...
        items={itineraryGuides.map((guide, index) => ({
          position: index + 1,
          name: guide.title,
          url: `${SITE_URL}/mauritius-itinerary#${guide.anchor}`,
          image: getImageUrl(guide.image, { width: 1200, quality: 80 }),
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-gray-700 text-base md:text-lg leading-relaxed space-y-4">
            <p>
              {t.intro.paragraph1Before}{" "}
              <span className="font-semibold text-orange-500">
                {t.intro.highlight}
              </span>{" "}
              {t.intro.paragraph1After}
            </p>
            <p>
              {t.intro.paragraph2Parts.beforeNorth}{" "}
              <Link
              ...
              >
                {t.intro.paragraph2Parts.north}
              </Link>{" "}
              {t.intro.paragraph2Parts.afterNorth}{" "}
              <Link
                href="/beaches-in-mauritius?region=West#beach-cards"
                className="font-semibold text-orange-500 underline underline-offset-4 hover:text-orange-600"
              >
                {t.intro.paragraph2Parts.west}
              </Link>{" "}
              {t.intro.paragraph2Parts.afterWest}{" "}
              <Link
                href="/beaches-in-mauritius?region=East#beach-cards"
                className="font-semibold text-orange-500 underline underline-offset-4 hover:text-orange-600"
              >
                {t.intro.paragraph2Parts.east}
              </Link>{" "}
              {t.intro.paragraph2Parts.afterEast}{" "}
              <Link
                href="/top-activities-mauritius/road-trip-south-coastal"
                className="font-semibold text-orange-500 underline underline-offset-4 hover:text-orange-600"
              >
                {t.intro.paragraph2Parts.south}
              </Link>{" "}
              {t.intro.paragraph2Parts.afterSouth}
            </p>
          </div>
        </div>
      </section>
                  ...
                  >
                    ...
                    <span className="text-sm md:text-base">
                      <span className="block font-semibold text-gray-900">
                        {t.days.dayLabel.replace("{days}", String(g.days))}
                      </span>
                      <span className="block text-gray-500 text-xs md:text-sm">
                        {t.days.descriptions[index]}
                      </span>
                    </span>
                  </a>
                </li>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl rounded-[26px] border border-[#eadbcf]  p-6 shadow-[0_18px_50px_rgba(31,24,19,0.06)] md:p-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 md:grid-cols-4">
              {[
                { value: "10", label: t.feature.stats[0] },
                { value: "3", label: t.feature.stats[1] },
                { value: "~60%", label: t.feature.stats[2] },
                { value: "~40%", label: t.feature.stats[3] },
              ].map((item) => (
                <div
                  key={item.label}
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl rounded-[26px] border border-[#eadbcf]  p-10 shadow-[0_18px_50px_rgba(31,24,19,0.06)] bg-white">
            ...
            <p className="mt-5 max-w-3xl text-[14px] italic leading-6 text-[#413a36] md:text-[15px]">
              {t.routeSection.descriptions.three}
            </p>
      ...
      <section className="bg-white  py-6 md:py-8">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl rounded-[26px] border border-[#eadbcf]  p-10 shadow-[0_18px_50px_rgba(31,24,19,0.06)] bg-white">
            ...
            <p className="mt-5 max-w-3xl text-[14px] italic leading-6 text-[#413a36] md:text-[15px]">
              {t.routeSection.descriptions.five}
            </p>
      ...
      <section className="bg-white  py-6 md:py-8">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl rounded-[26px] border border-[#eadbcf]  p-10 shadow-[0_18px_50px_rgba(31,24,19,0.06)] bg-white">
            ...
            <p className="mt-5 max-w-3xl text-[14px] italic leading-6 text-[#413a36] md:text-[15px]">
              {t.routeSection.descriptions.seven}
            </p>
      ...
      <section className="bg-white py-6 md:py-8">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl rounded-[26px] border border-[#eadbcf]  p-10 shadow-[0_18px_50px_rgba(31,24,19,0.06)] bg-white">
            ...
            <p className="mt-5 max-w-3xl text-[14px] italic leading-6 text-[#413a36] md:text-[15px]">
              {t.routeSection.descriptions.ten}
            </p>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 text-center">
              {t.sections.bestPlacesTitle}
            </h2>
            <p className="text-gray-700 text-base md:text-lg leading-relaxed text-center mb-8 max-w-3xl mx-auto">
              {t.sections.bestPlacesBody}
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">
              {t.sections.tipsTitle}
            </h2>
            <ul className="space-y-3 max-w-3xl mx-auto">
              {t.travelTips.map((tip) => (
                <li
                  key={tip}
