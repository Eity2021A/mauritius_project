      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">
            Things to Do in Mauritius FAQ
          </h2>
          <div className="grid gap-4 md:grid-cols-3">
            {TOP_15_FAQS.map((item) => (
              <article
                key={item.question}
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-orange-500 to-orange-600">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Plan Your Mauritius Activity Days
          </h2>
          <p className="text-white/90 text-lg mb-8">
            Choose your next island stop, from beach time and boat trips to Chamarel viewpoints, Casela adventures and easy family-friendly days.
          </p>
