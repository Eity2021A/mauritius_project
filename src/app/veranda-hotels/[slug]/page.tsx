...
export async function generateMetadata({
  ...
  return {
    title: `${hotel.name} | Veranda Collection | Mauritius Explored`,
...
function HotelBookingCta({
  ...
  const whatsappMessage = encodeURIComponent(
    `Hi, I want to know more about ${hotelName}: ${SITE_URL}${DETAIL_BASE}/${slug}`
  );
    ...
    <main id="main-content" className="min-h-screen bg-white">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Veranda hotels", url: `${SITE_URL}/veranda-hotels` },
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid lg:grid-cols-3 gap-7 md:gap-10 lg:gap-12">
            <div className="lg:col-span-2 space-y-7 md:space-y-10">
              <QuoteSection quote={hotel.tagline} />
              ...
              {hotel.idealFor.length > 0 && (
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Ideal For</h2>
                  <ul className="grid sm:grid-cols-2 gap-3">
              ...
              {hotel.rooms.length > 0 && (
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Rooms</h2>
                  <ul className="grid sm:grid-cols-2 gap-3">
              ...
              {hotel.dining.length > 0 && (
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Dining & Atmosphere</h2>
                  <ul className="grid sm:grid-cols-2 gap-3">
              ...
              {hotel.experiences.length > 0 && (
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Experiences Nearby</h2>
                  <ul className="grid sm:grid-cols-2 gap-3">
            ...
            <div className="lg:col-span-1">
              <div className="lg:sticky lg:top-24 space-y-6">
                <div className="lg:hidden rounded-lg border border-orange-100 bg-white p-5 shadow-md">
                  <HotelBookingCta hotelName={hotel.name} bookingUrl={hotel.bookingUrl} slug={hotel.slug} />
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-100 p-5 sm:p-6">
                  ...
                  <div className="space-y-1">
                    <InfoItem icon={<PriceIcon />} label="Price Guide" value={hotel.priceFrom} bordered />
                    <InfoItem icon={<LocationIcon />} label="Location" value={hotel.location} bordered />
                    <InfoItem icon={<StarIcon />} label="Rating" value={hotel.rating} bordered />
                    <InfoItem icon={<PalmIcon />} label="Style" value={hotel.style} bordered />
                    <InfoItem icon={<BedIcon />} label="Board Basis" value={hotel.boardBasis} />
                  </div>
                </div>
      ...
      <section className="py-10 md:py-12 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">More Hotels Like This</h2>
          <p className="text-gray-600 mb-8">Continue exploring the Veranda Collection in Mauritius</p>
